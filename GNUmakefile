...
QEMUFLAGS := -m 2G -M accel=tcg,smm=off -no-reboot -no-shutdown -audiodev pa,id=speaker -machine pcspk-audiodev=speaker -smp sockets=1,cores=2,threads=1 -d int --enable-kvm
