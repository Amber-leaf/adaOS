...
QEMUFLAGS := -m 2G -M accel=tcg,smm=off -no-reboot -no-shutdown -audiodev pa,id=speaker -machine pcspk-audiodev=speaker -smp sockets=1,cores=4,threads=1 --enable-kvm #-chardev stdio,id=char0,logfile=serial.log,signal=off \
